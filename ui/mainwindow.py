...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_pic = QtWidgets.QLabel(self.frame_imput_area)
        self.label_pic.setGeometry(QtCore.QRect(140, 25, 121, 91))
        self.label_pic.setText("")
        self.label_pic.setObjectName("label_pic")
        self.widget = QtWidgets.QWidget(self.frame_imput_area)
        self.widget.setGeometry(QtCore.QRect(40, 24, 721, 163))
        ...
        self.verticalLayout_3.addWidget(self.label_heading)
        self.label_heading2 = QtWidgets.QLabel(self.widget)
        self.label_heading2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_heading2.setObjectName("label_heading2")
        self.verticalLayout_3.addWidget(self.label_heading2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "K Verification-Insider Preview-Ver 0.1.0"))
        ...
        self.label_heading.setText(_translate("MainWindow", "学习资料"))
        self.label_heading2.setText(_translate("MainWindow", "请输入密码后访问"))
